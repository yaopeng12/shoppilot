...
const copy = {
  en: {
    ...
    results: {
      ...
      ali1688Products: "1688 Product Recommendations",
      selectedProduct: "Best Match",
      searchLinks: "More search links",
  ...
  zh: {
    ...
    results: {
      ...
      ali1688Products: "1688 商品推荐",
      selectedProduct: "最佳匹配",
      searchLinks: "更多搜索链接",
      viewOn1688: "在 1688 查看",
      minOrder: "起订量",
      transactions: "笔交易",
    },
  },
